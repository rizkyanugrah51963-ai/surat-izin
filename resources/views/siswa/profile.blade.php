                ...
                <div class="card border-0 shadow-sm overflow-hidden">
                    ...
                    <div class="card-body text-center profile-header">
                        ...
                        <div class="avatar-wrapper mb-3">
                            @if ($user->file)
                                <img src="{{ asset('user/assets/img/default-avatar.png') }}">
                        ...
                        <form action="{{ route('siswa.profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="d-flex align-items-center gap-3 p-3 border rounded-3 bg-light">
                                    <div>
                                        @if ($user->file)
                                            <img src="{{ $user->file->file_stream }}" id="profilePreviewSmall"
                                                class="avatar-sm">
                                        @else
                                    ...
                                    <div class="flex-fill">
                                        <input type="file" name="profile" id="profileInput" class="form-control"
                                            accept="image/*">
                                        <small class="text-muted">
                            ...
                            {{-- Jenjang Sekolah --}}
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Jenjang Sekolah</label>
                                <input type="text" class="form-control form-control-lg bg-light"
                                    value="{{ $user->jenjang_sekolah }}" readonly>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg bg-light"
                                    value="{{ $user->asal_sekolah }}" readonly>
                            </div>

                            {{-- ================= BUTTON ================= --}}
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('siswa.dashboard.user') }}" class="btn btn-light btn-lg">
                                    Batal
                                </a>
