...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-6 col-md-6 reveal" style="transition-delay:.2s">
                                        <div class="p-4 rounded" style="background:white; color:#333;">
                                            ...
                                            <p class="m-0">Sistem izin digital untuk siswa dengan proses cepat
                                                praktis
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 reveal" style="transition-delay:.3s">
                                        <div class="p-4 rounded" style="background:white; color:#333;">
                                            ...
                                            <p class="m-0">Pengajuan surat keterangan aktif sekolah secara digital
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="owl-carousel testimonial-carousel">
                                <div class="testimonial-item bg-transparent border rounded text-white p-4">
                                    <div class="ps-3">
                                        ...
                                        <p> Perkembangan teknologi telah membawa perubahan besar dalam berbagai sektor,
                                            termasuk pendidikan. Sekolah kini mulai beralih dari proses manual menuju
                                            sistem
                                ...
                                <div class="testimonial-item bg-transparent border rounded text-white p-4">
                                    <div class="ps-3">
                                        ...
                                        <p>Penggunaan layanan digital seperti SchoolPass membantu siswa menjadi lebih
                                            mandiri,
                                            teratur, dan bertanggung jawab. Mereka dapat mengajukan izin, melihat
                                            riwayat
                                            izin,
                                ...
                                <div class="testimonial-item bg-transparent border rounded text-white p-4">
                                    <div class="ps-3">
                                        ...
                                        <p>Surat izin digital memberikan solusi modern bagi sekolah dalam mengelola
                                            perizinan siswa.
                                            Dengan sistem ini, orang tua dan siswa dapat mengajukan izin secara online
                                            tanpa
                                            perlu
                                ...
                                <div class="testimonial-item bg-transparent border rounded text-white p-4">
                                    <div class="ps-3">
                                        ...
                                        <p>Lingkungan sekolah yang menerapkan teknologi digital akan bekerja lebih
                                            efektif
                                            dan hemat waktu.
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="team-item">
                                <div class="d-flex">
                                    ...
                                    <img class="img-fluid rounded w-100"
                                        src="{{ asset('user/assets/img/lelek2.png') }}" alt="">
                                </div>
                                <div class="px-4 py-3">
            ...
            <!-- Footer Start -->
            <div class="container-fluid text-light footer mt-5 pt-5 wow fadeIn" style="background-color: #1619ED;"
                data-wow-delay="0.1s">
                <div class="container py-5 px-lg-5">
                    <div class="row g-5">
